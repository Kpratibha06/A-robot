...
//function compareRobots takes two robots and there starting memory
//output is the average number of steps each robot took per task.
	
function compareRobots(robot1, memory1, robot2, memory2) {
	let r1 = 0, r2 = 0;
	for (let i = 0; i < 100; i++) {
		let state = Village.random();
		r1 += countSteps(state, robot1, memory1);
		r2 += countSteps(state, robot2, memory2);
	}
	 console.log(` Robot 1 ${r1 / 100}`);
	console.log(` Robot 2 ${r2 / 100}`);
}
